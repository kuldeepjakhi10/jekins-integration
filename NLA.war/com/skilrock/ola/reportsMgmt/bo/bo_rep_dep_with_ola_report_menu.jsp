...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 function _subTrans(){
	...
	<align="center"><body align="center" >
		<%@include file="/com/skilrock/lms/web/loginMgmt/menu.jsp"%>
		<div id="wrap">

			<div id="top_form">
				<h3>
					<s:text name="label.ola.bo.deposit/withdrawl.rep"/>
				</h3>
				<s:form name="searchgame"  action="olaBoDepWithReportResult" onsubmit="return validateDates()">
...
--><s:select key="label.wallet.name" id="walletName" name="walletName"  list="walletDetailsMap" listKey="value.walletDevName" listValue="value.walletDisplayName"
										cssClass="option" required="true" onchange="displayPassword(this.value);"></s:select></td></tr>
		...
		<tr>
			<td colspan="2"><s:submit name="submit" key="btn.srch" align="right"  targets="down" theme="ajax" cssClass="button" onclick="return _subTrans()" /></td>
		</tr>
					</table>
...
$RCSfile: bo_rep_dep_with_ola_report_menu.jsp,v $
$Revision: 1.1.2.3 $
</code>