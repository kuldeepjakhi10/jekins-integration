...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<head>
		...
		<script src="<%=request.getContextPath() %>/com/skilrock/ola/js/agtSearchPlayer.js"></script>
	...
	<body >
		...
		<div id="wrap">
			...
			<div id="top_form">
				...
				<s:form name="PlrSearch_Result" id="PlrSearch_Result" action="olaAgtPlrSearch_Result" onsubmit="return validateForm()">
					...
					<tr>
						<td>
								<s:select label="%{getText('Retailer')}" name="retOrgId" id="retOrgId" headerKey="-1" headerValue="--Please Select--"
					...
					<tr>
							...
							<td>
								...
								<s:select label="Wallet Name" id="walletName" name="walletName"  list="walletDetailsMap" listKey="value.walletDevName" listValue="value.walletDisplayName"
										cssClass="option" required="true" headerKey="-1" headerValue="--ALL--"  onchange="displayPassword(this.value);"></s:select>
							</td>
					</tr>
					<tr>
							<td colspan="2">
					...
					<tr>
					<td colspan="2" ><div id="dateDiv"  style="display:block;margin-left: 110px ">
					<table>
						<tr>
							<td >
								<label class="label">
...
<code id="headId" style="visibility: hidden">
	$RCSfile: agt_ola_search_plr_menu.jsp,v $ $Revision: 1.1.2.1 $
</code>
