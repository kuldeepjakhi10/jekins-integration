...
<body>
	...
	<div id="wrap"><div id="top_form">
		...
		<tr>				
			<!--<th colspan="7" align="center">OLA Agent Deposit/Withdraw Report</th>										
		-->
		<th colspan="3" align="center">OLA Agent Deposit/Withdraw Report</th>
		</tr>
		<!--<tr>
			<th colspan="1"></th>
		...
		<s:if test="#session.OLA_DEP_WITH_DATA_LIST.size>0">
			...
			<tr class="startSortable">				
				...
				<td align="left"><s:property value="retailerCommissionCalculated"/></td>							
			--></tr>	
			</s:if>
			<s:else>
				<tr>				
...
$RCSfile: agt_rep_dep_with_ola_report_result.jsp,v $
$Revision: 1.1.2.1 $
</code>