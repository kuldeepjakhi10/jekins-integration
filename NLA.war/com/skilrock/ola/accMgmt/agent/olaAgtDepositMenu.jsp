	...
	<body onload="clearDepositForm();">
		...
		<div id="wrap">
			<div id="top_form">
				...
				<div id="first">
					<s:form action="olaAgtDepositSave" id="depositFrm" onsubmit="return verifyDeposit()">
						<s:token  name="token" />
						...
						<table border="0" cellpadding="2" cellspacing="0" >
							...
							<tr>
								<td colspan="2">
									<s:textfield name="depositReqBean.depositAmt" label="Amount" id="amount"
										maxLength="7" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<s:textfield name="depositReqBean.refCode" label="Mobile Number" id="refCode"/></td>
