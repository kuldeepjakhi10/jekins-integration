...
<head>
	...
	<script src="<%=request.getContextPath() %>/com/skilrock/lms/web/accMgmt/agent/js/agt_accMgmt_creditNoteAgt.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath() %>/com/skilrock/lms/web/accMgmt/agent/js/Ragt_accMgmt_digitToWord.js"></script>
...
<body onload="getRetailerUserList();">
	...
	<s:div  id="x">
		<s:form  action="agt_act_creditNote_Entry" onsubmit="return validateData()">
...
$RCSfile: agt_act_creditNote_Menu.jsp,v $
$Revision: 1.1.2.4.8.1.2.3 $
</code>