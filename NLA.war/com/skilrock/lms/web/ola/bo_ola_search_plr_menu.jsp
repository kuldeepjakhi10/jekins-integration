...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<head>
		...
		<script src="<%=request.getContextPath() %>/com/skilrock/lms/web/ola/js/searchPlayer.js"></script>
		...
		<div id="wrap">
			...
			<div id="top_form">
				...
				<s:form name="PlrSearch_Result" id="PlrSearch_Result" action="olaBoPlrSearch_Result" onsubmit="return validateForm()">
					...
					<tr>
						<td>
								<s:select label="%{getText('Agent')}" name="agentOrgId" id="agentOrgId" headerKey="-1" headerValue="--Please Select--"
