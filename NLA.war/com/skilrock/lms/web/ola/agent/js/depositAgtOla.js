...
if(walletValue=="-1"){
	...
	var walletDisplayName = walletValue.split(":");
	var walletDevName = walletDisplayName[1];
	url = "agt_um_playerReg_Availability.action?userName="+userName+"&walletName="+walletValue;
...
parent.frames[0].Version["$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/ola/agent/js/Attic/depositAgtOla.js,v $"] = "$Id: depositAgtOla.js,v 1.1.2.1 2013/10/03 12:56:57 yogesh Exp $";