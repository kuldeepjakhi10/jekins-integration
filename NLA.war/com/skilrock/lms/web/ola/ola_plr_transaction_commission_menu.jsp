...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body onload="fetchActiveWallets('<%=request.getContextPath()%>');fetchCommUpdateType('<%=request.getContextPath()%>'); ">
		...
		<div id="wrap">
			...
			<div id="top_form">
				<h3>
					Ola Player Transaction and Commission Report
					
				</h3>


				<s:form name="olaPlrTransactionCommissionSUCCESS" id="olaPlrTransactionCommissionSUCCESS" action="olaPlrTransactionCommissionSUCCESS" onsubmit="return isSelected()">
...
<code id="headId" style="visibility: hidden">
	$RCSfile: ola_plr_transaction_commission_menu.jsp,v $ $Revision: 1.1.2.2 $
</code>