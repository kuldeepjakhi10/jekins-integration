	...
	<body onload="fetchActiveWallets('<%=request.getContextPath()%>')" >
		...
		<div id="wrap">
			...
			<div id="top_form">
				...
				<s:form  action="ret_rep_ola_report_success" onsubmit="return validateDates()">
...
<s:select label="Wallet Name" name="walletName" headerKey="-1"
 ...
 <tr><td>
<s:select label="Player Type" name="playerType" headerKey="-1"
														id="playerType" headerValue="--All--"
														 list="#{'Bind':'Ola Bind','Notbind':'Ola Not Bind'}" 
									...
									<tr>
										<td>
											...
											<input type="button"
												...
												onclick="displayCalendar(document.getElementById('start_date'),'yyyy-mm-dd', this, '<%=startDate%>', false, '<%=startDate%>')" />
										</td>
									</tr>
									<tr>
										<td>
...
$RCSfile: ret_rep_ola_report_menu.jsp,v $
$Revision: 1.1.2.4 $
</code>