...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body onload="fetchActiveWallets('<%=request.getContextPath()%>');fetchCommUpdateType('<%=request.getContextPath()%>'); ">
		...
		<div id="wrap">
			...
			<div id="top_form">
				<h3>
					Approve Net Gaming Expenses for
					<s:property value="#application.TIER_MAP.AGENT" />
				</h3>


				<s:form name="netGamingApprove" id="netGamingApprove"  onsubmit="return isSelected(),fetchActData()">
						...
						<tr>
							...
							<td>
									<s:select label="Wallet Name" name="walletName" headerKey="-1"
										id="walletName" headerValue="--Please Select--" list="{'RUMMY'}"
						...
						<tr>
							...
							<td nowrap="nowrap">
								...
								<s:select theme="simple" id="netGamingExpType" cssClass="option"
									list="{'WEEKLY','MONTHLY'}" name="netGamingExpType"
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_ola_net_gaming_exp_Menu.jsp,v $ $Revision: 1.1.2.4 $
</code>