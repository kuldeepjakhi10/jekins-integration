	...
	<div id="wrap">
  	<div id="top_form">
		...
		<s:form method="get">
			...
			<table>
			<tr>
			  <td><s:a theme="simple" href="bo_im_consNonConsAsignInv_menu.action"><s:text name="label.dispatch.another.order"/></s:a></td>
			</tr>  
			<!--  
			<tr>  
			  <td>
...
$RCSfile: bo_im_consNonConsAsignInv_success.jsp,v $
