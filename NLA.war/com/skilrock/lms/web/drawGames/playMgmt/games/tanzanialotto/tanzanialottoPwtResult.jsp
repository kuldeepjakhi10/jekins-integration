...
document.write "<object ID='WB' WIDTH=0 HEIGHT=0 CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'></object>"
	...
	<body>
		...
		<div id="maincontainer">
			...
			<div class="drawgame_name">ZIMLOTTO TWO</div>
		...
		finalData.append(tempRecptData + "|verifiedAt=" + verifiedAt + "|totMainTktAmt=" + totMainTktAmt + "|ctr=" + (pwtConstantSize + pwtHeightCounter + appletHeight + regButtonHeight + 100));

		System.out.println("Tanzania Lotto Winning DATA: " + finalData.toString());
	}
	%>		
...
$RCSfile: tanzanialottoPwtResult.jsp,v $
$Revision: 1.1.2.5 $
</code>