...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<head>
		...
		<title><s:property value="%{fortuneBean.ticket_no}" /> <s:property
				value="%{fortuneBean.reprintCount}" /></title>
		...
		<div class="center">
			...
			<%	try{
				...
				if(fortuneBean.getRafflePurchaseBeanList() != null){
					appletHeight  = Util.getRaffData(fortuneBean.getRafflePurchaseBeanList(), raffleData, appletHeight);
				}
				...
				String finalData = "data=" + fortuneBean.getTicket_no() + fortuneBean.getReprintCount() 
								...
								+ "|ctr=" + appletHeight;
				System.out.println("FORTUNE PURCHASE DATA: " + finalData);
			%>
...
$RCSfile: fortuneSuccess.jsp,v $
$Revision: 1.12.2.15.4.3.2.10 $
</code>