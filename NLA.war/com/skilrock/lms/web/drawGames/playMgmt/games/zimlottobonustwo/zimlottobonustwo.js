...
var _zimlottobonustwoWinArr = new Array();
var _zimlottobonustwoDrawIdArr = new Array();

var curDrwTimelotto = "";
var zimlottobonustwocurSel = "row1";
var zimlottobonustwoIsAllQP = false;
var _zimlottobonustwoPrice = parseFloat(gameDispName["zimlottobonustwo"].unitPrice.split("=")[1], 10);
var playType;
var startPoint;
var _zimlottobonustwodrawSelect;
function setDefaultzimlottobonustwo() {
	curDrwTimefortune = "";
	zimlottobonustwocurSel = "row1";
	zimlottobonustwoIsAllQP = false;
	playType = "Direct6";
	startPoint = 1;
}
function _zimlottobonustwoWinAppend() {
	if (!_zimlottobonustwoWin.match("Result Awaited")) {
		_zimlottobonustwoWin = "Result Awaited=\"\" Nxt" + _zimlottobonustwoWin;
	}
}
function _zimlottobonustwoLatestDrawTime() {
	return _zimlottobonustwoStatus.split("=")[1];
}
function _zimlottobonustwoFillWinTbl() {
	var _zimlottobonustwoWinHt = "<table width=\"100%\" border=\"0\" bordercolor=\"red\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#FFF1D2\"><tr><td colspan=\"2\" align=\"left\"><div valign=\"middle\" style=\"height:22px;background-color:#F8AD40;padding-top:3px;font-size:16px;font-family:Arial;font-weight:bold;color:#FFFFFF\">&nbsp;Win Result&nbsp;</div></td></tr><tr><td valign=\"top\" align=\"center\">";
	var winArr = _zimlottobonustwoWin.split("Nxt");
	var _zimlottobonustwoWinHTML = "<table width=\"100%\" border=\"0\" style=\"margin-top:3px\"><tr><td><div style=\"" + scrollColor("#FFDF96", "#F8AD40", "184") + "\">";
	for (var i = 0; i <= winArr.length - 2; i++) {
		if (!winArr[i].match("Result")) {
			...
			var htm = "<table width=\"90%\" border=\"0\" bordercolor=\"green\" id=\"result" + i + "\" cellspacing=\"2\" cellpadding=\"10\" class=\"zimlottobonustwo_winningResult_table\"><tr><td class=\"zimlottobonustwowinningResultTime\" colspan=\"8\" height=\"39\">" + newTime + "</td></tr><tr>";
			...
			for (var j = 0; j < num.length; j++) {
				...
				htm = htm + "<td width=\"10%\" align=\"center\"><span class=\"selected_win_zimlottobonustwo_numbers\">" + trim(temp, " ") + "</span></td>";
			}
			htm = htm + "</tr></table>";
			_zimlottobonustwoWinHTML = _zimlottobonustwoWinHTML + htm;
		} else {
			var htm = "<table width=\"90%\" bordercolor=\"blue\" border=\"0\" cellspacing=\"2\" cellpadding=\"10\" id=\"result" + i + "\" class=\"zimlottobonustwo_winningResult_table\" ><tr><td class=\"zimlottobonustwowinningResultTime\" colspan=\"8\" height=\"44\" >Result Awaited</td></tr><tr>";
			htm = htm + "<td class=\"selected_win_zimlottobonustwo_numbers\" colspan=\"8\"><div style=\"text-align:center\" id=\"winAwaitedDiv\" style=\"color:#DD8C17\"></div></td>";
			htm = htm + "</tr></table>";
			_zimlottobonustwoWinHTML = _zimlottobonustwoWinHTML + htm;
		}
	}
	_zimlottobonustwoWinHTML = _zimlottobonustwoWinHTML + "</div></td></tr></table>";
	return _zimlottobonustwoWinHt + _zimlottobonustwoWinHTML + "</td></tr></table>";
}
function _zimlottobonustwoWinAjx() {
	var url = "fetchWinzimlottobonustwo.action?frmDate=" + _zimlottobonustwoWinArr[_zimlottobonustwoWinArr.length - 1];
	_zimlottobonustwoWin = _zimlottobonustwoWin + (winAjaxReq(url)).data;
	_zimlottobonustwoFillWinTbl();
}
function zimlottobonustwoNmSel(lstNo) {
	...
	for (var i = 1; i <= lstNo; i++) {
		if (i % 5 == 0) {
			htm = htm + "<td width=\"17%\" align=\"right\" valign=\"middle\" style=\"cursor:pointer;background:url(" + projectName + "/LMSImages/images/zimlottobonus_shade_white.gif) center no-repeat\" class=\"selected_zimlottobonustwo_numbers\" onmouseout=\"zimlottobonustwoonmouseouteffect(this.id)\" onmouseover=\"zimlottobonustwoonmouseovereffect(this.id)\"  onclick=\"fillNumzimLtoBonus(" + i + ")\"  id=\"" + i + "\" >" + (i < 10 ? "0" + i : i) + "</td></tr>";
		} else {
			htm = htm + "<td width=\"17%\" align=\"right\" valign=\"middle\"  class=\"selected_zimlottobonustwo_numbers\"  style=\"cursor:pointer;background:url(" + projectName + "/LMSImages/images/zimlottobonus_shade_white.gif) center no-repeat\" onmouseout=\"zimlottobonustwoonmouseouteffect(this.id)\" onmouseover=\"zimlottobonustwoonmouseovereffect(this.id)\" onclick=\"fillNumzimLtoBonus(" + i + ")\"  id=\"" + i + "\"  >" + (i < 10 ? "0" + i : i) + "</td>";
		}
	}
	htm = htm + "</tr></table></div>";
	return htm;
}
function zimlottobonustwoonmouseovereffect(id) {
	var count = 0;
	var isFilled = false;
	for (var i = 1; i <= 36; i++) {
		if (_id.o(i).className == "selected_zimlottobonustwo_numbersSelect") {
			count++;
		}
		if (count > 5) {
			isFilled = true;
	...
	if (!isFilled && !zimlottobonustwoIsAllQP) {
		if (_id.o(id).className != "selected_zimlottobonustwo_numbersSelect") {
			...
			_id.o(id).className = "selected_zimlottobonustwo_numbersSelectOMO";
		}
	}
}
function zimlottobonustwoonmouseouteffect(id) {
	if (!zimlottobonustwoIsAllQP) {
		if (_id.o(id).className == "selected_zimlottobonustwo_numbersSelectOMO") {
			...
			_id.o(id).className = "selected_zimlottobonustwo_numbers";
		} else {
			if (_id.o(id).className == "selected_zimlottobonustwo_numbersSelect") {
				_id.o(id).style.background = "url(" + projectName + "/LMSImages/images/zimlottobonus_shade_over.gif) center no-repeat";
				_id.o(id).style.color = "#FFFFFF";
			} else {
				if (_id.o(id).className == "selected_zimlottobonustwo_numbers") {
					_id.o(id).style.background = "url(" + projectName + "/LMSImages/images/zimlottobonus_shade_white.gif) center no-repeat";
					_id.o(id).style.color = "#DD8C17";
				}
			}
...
function zimlottobonustwoChkQP(id) {
	if (_id.o(id).checked == true) {
		zimlottobonustwoIsAllQP = true;
		//_id.o("tkts").readOnly = false;
		zimlottobonustwoapplyCSS();
		if(playType=='Direct6'){
		_id.o("tkts").value = "";
		_id.o("tkts").readOnly = false;
		_id.o("tkts").focus();
...
function zimlottobonustwoRow(noOfpanels) {
	...
	for (var i = 1; i < parseInt(noOfpanels) + 1; i++) {
		...
		for (var j = 0; j < 6; j++) {
			htm = htm + "<td align=\"center\" valign=\"middle\" ><input type=\"text\" class=\"selected_zimlottobonustwo\" maxlength=\"2\" onkeydown=\"return keyPresszimLtoBonus(this," + i + ",event)\" onkeyup=\"return keyPresszimLtoBonus(this," + i + ",event)\" onblur=\"blurFnzimLtobonus(this)\" onmousedown=\"return disClick(this)\"></td>";
		}
		htm = htm + "</tr>";
	}
	return htm + "</table>";
}
function zimlottobonustwoclearBoxes(val) {
	_id.resetInpTypes("row" + val, "selected_zimlottobonus", false);
	_zimlottobonusCalAmt();
}
function zimlottobonustwoclearAllBoxes() {
	...
	_zimlottobonustwoCalAmt();
	document.getElementsByName('conOrNonCon')[0].click();
}
function _zimlottobonustwoFillNxtDrw() {
	...
	_zimlottobonustwodrawSelect = '<table width="auto" cellspacing="0"cellpadding="0"  border="1"><tr><td colspan="3" align="center"><b>Select Draws</td></tr>';

	var nxtDrwArr = _zimlottobonustwoDrawTime.split(",");
	for (var i = 0, l = nxtDrwArr.length; i < l; i++) {
		...
		if (i == 0) {
			...
			_zimlottobonustwoNxtDrawTime = ("" + time).substring(0, ("" + time).lastIndexOf(":") + 3);
		}
		if (i % 2 == 0) {
			rowcolor = "#FFF1D2";
		} else {
		...
		drawName = _zimlottobonustwoDrawIdObj[parseInt(nxtDrwArr[i].replace(" ", ""))].split(',')[1];
		if(drawName == 'null'){
			drawName = 'DRAW';
		}
		_zimlottobonustwodrawSelect = _zimlottobonustwodrawSelect + '<tr><td align="right"><input type="checkbox" title="'+newTime+'" name="drawIdChkBox" value="'+drawName+'" id="'+ _zimlottobonustwoDrawIdObj[parseInt(nxtDrwArr[i].replace(" ", ""))].split(',')[0] +'_did"/></td><td width="30%" nowarp="nowrap">'+drawName+'</td><td align="center">'+newTime+'</td></tr>'
	
	}
	nxtDrwHTML = nxtDrwHTML + "</table></div></td></tr></table></div></td></tr></table>";
	
	_zimlottobonustwodrawSelect = _zimlottobonustwodrawSelect + '<tr><td colspan="3" align="right"><input class="button" id="selNonConsecButton" onclick="drawSelectButton()" type="button" value="Select"/></td></tr></table>'
    //alert("_zimlottobonusdrawSelect"+_zimlottobonusdrawSelect);
	return nxtDrwHTML;
}
function _zimlottobonustwoUpData(win, drwTime, drwStatus) {
	_zimlottobonustwoWin = win;
	_zimlottobonustwoDrawTime = drwTime;
	_zimlottobonustwoStatus = drwStatus;
}
function fillSelzimLtoBonus(val) {
	if (!zimlottobonustwoIsAllQP) {
	countFill=0;
		zimlottobonustwocurSel = "row" + val;
		_id.o("radio" + val).checked = true;
		var newObjR=_id.o(zimlottobonustwocurSel);
...
function fillNumzimLtoBonus(val) {   
	if (!zimlottobonustwoIsAllQP) {
		var objR = _id.o(zimlottobonustwocurSel);
		var clrChg = true;
		var elms = objR.getElementsByTagName("input");
		if (_id.o(val).className == "selected_zimlottobonustwo_numbersSelect") {
		...
		if(playType=="Direct6" && countFill==6){
			//alert(parseInt(zimlottobonustwocurSel.replace("row",""),10)+1);
			countFill=0;
			var rowNo=parseInt(zimlottobonustwocurSel.replace("row",""),10)+1;
			if(rowNo>4){
				rowNo=1;
			}			
			zimlottobonustwocurSel="row"+rowNo;
...
function _zimlottobonustwoCalAmt() {
	...
	if(_id.n('conOrNonCon')[0]!= undefined && _id.n('conOrNonCon')[0].checked){
		...
		noOfDrw = _zimlottobonustwoDrawIdArr.length;
	}
	...
	var totalPrice=noOfDrw * noOfPanel * _zimlottobonustwoPrice;
...
function keyPresszimLtoBonus(obj, val,e) {
	...
	if ((keyCode >= 48 && keyCode < 58) || keyCode == 45 || keyCode == 27 || keyCode == 13 || keyCode == 40 || keyCode == 38 || keyCode == 46 || keyCode == 8 || (keyCode >= 96 && keyCode < 106 || keyCode == 9)) {
		...
		if (obj.value.length > 1) {
			if (obj.value == 0 || obj.value > 36 || isNaN(obj.value)) {
				obj.value = "";
				obj.focus();
			} else {
				var objR = _id.o(zimlottobonustwocurSel);
				...
				if (clrChg) {
					...
					if (selNxtRow) {
						var nxtRow = parseInt(zimlottobonustwocurSel.substring(zimlottobonustwocurSel.length - 1), 10) + 1;
						if (nxtRow <= 4) {
							var nxtRowStr = zimlottobonustwocurSel.substring(0, zimlottobonustwocurSel.length - 1) + nxtRow;
						//alert(nxtRowStr);
...
function zimlottobonustwoapplyCSS() {
	for (var i = 1; i <= 36; i++) {
		_id.o(i).className = "selected_zimlottobonustwo_numbers";
	...
	var clrChg = true;
	var obj = _id.o(zimlottobonustwocurSel);
	...
	for (var l = startPoint; l < elms.length; l++) {
		if (elms[l].value != "") {
			if (count < maxCount) {
				_id.o(parseInt(elms[l].value, 10)).className = "selected_zimlottobonustwo_numbersSelect";
	...
	if (zimlottobonustwoIsAllQP) {
		for (var i = 1; i <= 36; i++) {
			_id.o(i).className = "selected_zimlottobonustwo_numbersDisabled";
...
function buyTicketzimlottobonustwo(id) {
	//alert(playType);
	var compData = "";
	var noPicked = 6;
	if (playType == "Direct6") {
		if (!zimlottobonustwoIsAllQP) {
			for (var i = 1; i <= 4; i++) {
				...
				if (inputData != "" && checkNumber(inputData.substring(0, inputData.length - 1), 1, 36)) {
					alert("Please fill Number only between 1 to 36");
					return false;
				}
	...
	if(_id.n('conOrNonCon')[1]!= undefined && _id.n('conOrNonCon')[1].checked){
		var html = '';
		for(i=0; i<_zimlottobonustwoDrawIdArr.length;i++){
			html += '&drawIdArr='+_zimlottobonustwoDrawIdArr[i];
		}
		html+='&isAdvancedPlay=1';
       //alert("noOfDraws"+ _id.n("noOfDraws")[0].value);
		 gameBuyAjaxReq("zimLottoBonusTwoBuy.action?noPicked=" + noPicked + "&playType=" + playType + "&pickedNumbers=" + compData + "&noOfDraws=" + _zimlottobonustwoDrawIdArr.length +"&totalPurchaseAmt=" + amount +html );
			}
	else{
	      // alert("noOfDraws0:::::::"+ _id.n("noOfDraws")[0].value);
		    ...
		    gameBuyAjaxReq("zimLottoBonusTwoBuy.action?noPicked=" + noPicked + "&playType=" + playType + "&pickedNumbers=" + compData + "&noOfDraws=" + _id.n("noOfDraws")[0].value + "&totalPurchaseAmt=" + amount +"&isAdvancedPlay=" + 0 );

}
	
	
	zimlottobonustwoclearAllBoxes();
	return true;
}
function zimlottobonustwoMultiPlay() {
	...
	for (var i = 0; i < playTypeObj.length; i += 1) {
		if (playTypeObj[i].checked == true) {
			if (playTypeObj[i].value == "Direct6") {
				_id.o("playDiv").innerHTML = zimlottobonustwoRow("4");
				zimlottobonustwocurSel = "row1";
				startPoint = 1;
			} else {
				if (playTypeObj[i].value == "Perm6") {
					_id.o("playDiv").innerHTML = zimlottobonustwoPermTlb();
					zimlottobonustwocurSel = "lottoRow";
					startPoint = 0;
				}
			}
...
function zimlottobonustwoPermTlb() {
...
var line = "<tr><td bgcolor=\"#F8AD40\"><table border=\"0\" bordercolor=\"blue\" width=\"97%\"><tr><td align=\"left\" width=\"25%\"><input type=\"hidden\" value=\"0\" id=\"counterId\"><input type=\"hidden\" id=\"dateFuture\"><input type=\"hidden\" id=\"freezeTimeId\" value=\"" + _zimlottobonustwofreezeTime + "\"><span class=\"style1\">Next Draw :</span><div id=\"latestDrawTime\" style=\"display:none\"></div></td><td width=\"30%\" align=\"left\"><div id=\"nxtDrawTime\" class=\"zimlottobonusstyle2\"></div></td><td align=\"right\" width=\"25%\"><div id=\"timeLeft\"><span class=\"style1\"> Time Left :</div></span></td> <td align=\"left\" width=\"15%\"><div id=\"curDrwTime\" class=\"zimlottobonusstyle2\"></div> </td><!--<td rowspan=\"2\" width=\"10%\"><img src=\"" + fortImgPath + "que.gif\" style=\"cursor:hand;\" onClick=\"gameInfo()\" alt=\"Game Info\" /> </td>--></tr> <tr bgcolor=\"#F8AD40\"><td align=\"left\"> <span class=\"style1\">No. of Draws :</span> </td> <td > <table><tr><td> <input type=\"radio\"/ name=\"conOrNonCon\" value=\"consec\" checked='true'  onclick=\"drawSelectButton(this)\"'/></td>  <td><select\tname=\"noOfDraws\" id=\"noOfDraws\"\tclass=\"fortune_option\" align=\"left\"\twidth=\"20%\"\tonchange=\"_zimlottobonustwoCalAmt()\">" + getActiveDrawOptionList("zimlottobonustwo") + "</select> </td></tr>  </table>        </td>  <td>     <table> <tr><td><input type=\"radio\"/ name=\"conOrNonCon\" value=\"nonconsec\" onclick=\"specificDrawPopUp(_zimlottobonustwodrawSelect)\" />  </td><td class=\"style1\">Advance Draw</td></tr></table>    </td>     <td colspan=\"1\" align=\"left\" valign=\"top\"> &nbsp; </td><td align=\"left\"> <span class=\"zimlottobonusnum\">" + currSymbol + " " + _zimlottobonustwoPrice + "/-</span></td>  </tr><tr><td><table><tr><td align=\"right\" height=\"0px\" width=\"0px\"  id=\"drawSelectorDiv\" style=\"visibility:hidden;position:absolute;background-color:#FFFFFF\"></td></tr></table></td> </tr>         </table></td></tr>";

var _zimlottobonustwoNxtDrwTbl = _zimlottobonustwoFillNxtDrw();
var _zimlottobonustwoHtmlTbl = "<table width=\"100%\" height=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" bordercolor=\"red\" bgcolor=\"#FFF1D2\">" + line + "<tr><td align=\"center\" valign=\"top\"><table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tr><td width=\"45%\" valign=\"top\"><div style=\"padding-top:10px;\"><table border=\"0\" bordercolor=\"red\" width=\"97%\" align=\"center\"cellpadding=\"0\"cellspacing=\"0\"><tr><td class=\"style10\" align=\"left\"><div id='jackpotAmt' align=\"center\" valign=\"middle\" style=\"height:18px;background-color:#F8AD40;width:180px;float:left;padding-top:2px\"></div></td></tr><tr><td valign=\"middle\" style=\"border:1px #F8AD40 solid;background-color:#FFDF96\">" + zimlottobonustwoNmSel(36) + "</td></tr></table></div></td><td valign=\"top\" wdith=\"35%\"><div style=\"border:0px solid black; padding-top:10px;\"><table border=\"0\" bordercolor=\"green\" width=\"96%\" cellpadding=\"0\" cellspacing=\"0\" align=\"center\" style=\"margin-right:10px\">             <tr><td><input type='radio' name='playType' value='Direct6' checked='true' onclick='zimlottobonustwoMultiPlay()'>Direct-6<input type='radio' name='playType' value='Perm6' onclick='zimlottobonustwoMultiPlay()'>Perm-6</td><td align=\"right\" class=\"style10\" style=\"cursor:hand;\" onclick=\"zimlottobonustwoclearAllBoxes()\" ><div align=\"center\" valign=\"middle\" style=\"height:18px;background-color:#F8AD40;width:100px;float:right;padding-top:2px\">&nbsp;&nbsp;&nbsp;Clear All&nbsp;&nbsp;&nbsp;</div></td></tr><tr><td valign=\"middle\" style=\"border:1px #F8AD40 solid;background-color:#FFDF96\" colspan=2><table width=\"100%\" border=\"0\" align=\"center\" cellspacing=\"0\" cellpadding=\"0\"><tr><td><div id='playDiv'>" + zimlottobonustwoRow("4") + "</div></td></tr><tr><td bgcolor=\"#F8AD40\"><table width=\"95%\" border=\"0\" style=\"margin:6px 0px 5px 0px;\"><tr><td align=\"center\" class=\"style5\" rowspan=\"2\"><div style=\"border:1px #FFFFFF solid; width: 50px; height: 40px; float: left;\">QP<br /><input type=\"checkbox\" id=\"qpChkAll\" onclick=\"zimlottobonustwoChkQP(this.id)\" style=\"border:1px #F8AD40 solid\" /></div></td><td class=\"zimlottobonustxtStyle\" align=\"left\">Total Qty:</td><td><input type=\"hidden\" value=\"\" id=\"pickedNumbers\" name=\"pickedNumbers\" /><input type=\"text\" class=\"zimlottobonustextbox\" id=\"tkts\" readonly=\"true\" value=\"0\" onkeyup='return keyPressQPzimLtoBonus(this,event)' onkeydown='return keyPressQPzimLtoBonus(this,event)' onmousedown=\"return disClick(this)\"  /></td><td rowspan=\"2\"><a href=\"#\"><img src=\"" + fortImgPath + "zimlottobonus_buy.gif\" id='buy' onclick=\"return buyTicketzimlottobonustwo(this.id)\" alt=\"Buy\" style=\"margin-right: 4px;\" /></a></td></tr><tr><td class=\"zimlottobonustxtStyle\" align=\"left\">Total Amount:</td><td><input type=\"text\" id=\"totAmtLto\" name=\"totalPurchaseAmt\" value=\"0\" readonly=\"true\" class=\"zimlottobonustextbox\" /></td></tr> </table></td></tr></table></td></tr></table></div></td></tr></table></tr><tr><td style=\"line-height:10px\">&nbsp; <div id=\"selectedDrawList\">No Draws Selected. Please Select at least one draw!</div> </td></tr></table>";


var _zimlottobonustwoHTML = "<div id=\"strip\">" + drwMenu + "</div><form style=\"background-color:#FFFFFF;border: 1px solid #393939;\"><table  border=\"0\" width=\"100%\" height=\"100%\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" bgcolor=\"#FFFFFF\" bordercolor=\"red\"><tr><td width=\"10%\"  valign=\"top\" align=\"center\" onmousedown=\"return disClick(this)\"><input type=\"hidden\" id=\"drawType\"><div id=\"winningDispDiv\" style=\"border:1px #F8AD40 solid;background-color:#FFFFFF;margin-left:5px;margin-top:3px\"></div><div id=\"nxtDrawDiv\" style=\"border:1px #F8AD40 solid;background-color:#FFFFFF;margin-left:5px;margin-top:5px\"></div></td><td width=\"90%\" valign=\"top\"><div id=\"zimlottobonusmiddle\" style=\"border:1px #F8AD40 solid;background-color:#FFDF96;width:98%;margin-left:5px;margin-top:3px;margin-bottom:1px\">" + _zimlottobonustwoHtmlTbl + "</div></td></tr></table></td></tr></table></form>";



parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/drawGames/playMgmt/games/zimlottobonustwo/Attic/zimlottobonustwo.js,v $'] = '$Id: zimlottobonustwo.js,v 1.1.2.1 2014/03/30 08:02:02 yogesh Exp $';