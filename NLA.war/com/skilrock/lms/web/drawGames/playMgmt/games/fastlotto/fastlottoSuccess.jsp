		...
		<div class="center">
			...
			<%	try{
				...
				String finalData = "data=" + lottoPurchaseBean.getTicket_no() + lottoPurchaseBean.getReprintCount()
								...
								+ "|totalQuantity=" + lottoPurchaseBean.getPanel_id().length 
								...
								+ "|ctr=" + appletHeight;
				System.out.println("FASTLOTTO PURCHASE DATA: " + finalData);
			%>
...
$RCSfile: fastlottoSuccess.jsp,v $
$Revision: 1.1.2.5.4.3.2.9 $
</code>