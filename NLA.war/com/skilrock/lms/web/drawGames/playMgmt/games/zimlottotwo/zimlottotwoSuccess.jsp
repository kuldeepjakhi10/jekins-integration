...
document.write "<object ID='WB' WIDTH=0 HEIGHT=0 CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'></object>"
	...
	<body>
				...
				<%
					...
					if("Perm6".equalsIgnoreCase(lottoPurchaseBean.getPlayType())){
						...
						appletHeight=appletHeight+constantSize;
							appletHeight=appletHeight*lottoPurchaseBean.getPromoPurchaseBeanList().size();
							}
				String retName= Util.getOrgNameFromTktNo((lottoPurchaseBean.getTicket_no() + lottoPurchaseBean.getReprintCount()), (String)application.getAttribute("ORG_TYPE_ON_TICKET"));
					...
					if(lottoPurchaseBean.getPromoPurchaseBeanList() != null){
					for(int k=0;k<lottoPurchaseBean.getPromoPurchaseBeanList().size();k++ ){
					...
					String promoOriginalData = "|currSymbol=" + application.getAttribute("CURRENCY_SYMBOL")
							...
							+"|retailerNameReprint="+retName
							+ "|verifiedAt=" + verifiedAt 
							+ "|ticketExpiryEnabled=" + application.getAttribute("TICKET_EXPIRY_ENABLED");
					promoData = Util.getPromoData(lottoPurchaseBean.getPromoPurchaseBeanList().get(k) , promoOriginalData);
		...
		String appData = finalData + finalPromoData.toString();
		System.out.println("ZIM LOTTO TWO PURCHASE CUM PROMO DATA: " + appData);
...
$RCSfile: zimlottotwoSuccess.jsp,v $
$Revision: 1.1.2.11 $
</code>