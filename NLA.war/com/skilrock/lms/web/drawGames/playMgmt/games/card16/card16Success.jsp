...
<%
	List<String> sunSign = Arrays.asList("", "ace_spade", "ace_heart",
		...
		<div class="center" id="appletDiv">
			<%	try{
				...
				String finalData = "data=" + fortuneBean.getTicket_no() + fortuneBean.getReprintCount() 
								...
								+ "|ctr=" + appletHeight;
				System.out.println("CARD16 PURCHASE DATA: " + finalData);
			%>
...
$RCSfile: card16Success.jsp,v $
$Revision: 1.11.2.15.4.4.2.9 $
</code>