...
<%
	pageContext.setAttribute("gameName", "KenoFour");
	...
	if (isReprint) {
		...
		appletHeight = UtilApplet.getAdvMsgs(kenoBean.getAdvMsg(), topMsgsStr, bottomMsgsStr, appletHeight);
			...
			System.out.println("**raffleData*****" + raffleData + "***"+kenoBean.getBarcodeCount());
...
document.write "<object ID='WB' WIDTH=0 HEIGHT=0 CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'></object>"
	...
	<body>
		...
		<%
			...
			System.out.println("KENO FOUR Winning DATA: " + finalData.toString());
		 %>
...
$RCSfile: kenoFourPwtResult.jsp,v $
$Revision: 1.1.4.5.2.2 $
</code>