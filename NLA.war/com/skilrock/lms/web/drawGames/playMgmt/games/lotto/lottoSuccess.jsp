<%@ page import="java.util.*,com.skilrock.lms.dge.beans.LottoPurchaseBean,com.skilrock.lms.web.drawGames.common.Util"%>
		...
		<div class="center">
			...
			<%	try{
				...
				String finalData = "data=" + lottoPurchaseBean.getTicket_no() + lottoPurchaseBean.getReprintCount()
								...
								+ "|ctr=" + appletHeight;
				System.out.println("LOTTO PURCHASE DATA: " + finalData);
			%>
...
$RCSfile: lottoSuccess.jsp,v $
$Revision: 1.9.2.13.4.3.2.9.10.1 $
</code>