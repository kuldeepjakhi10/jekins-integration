...
<body>
  ...
  <s:form name="searchgame" action="bo_dg_rep_sale_Search" onsubmit="return validateDates()"> 		
	 <table  border="0" cellpadding="2" cellspacing="0" width="400px">
		...
		<tr>
			<td colspan="2"><s:select name="filter" label="%{getText('Report')} for" list="#{'Game Wise':'Game Wise', 'Agent Wise':#application.TIER_MAP.AGENT + ' Wise', 'Retailer Wise':#application.TIER_MAP.RETAILER + ' Wise'}" cssClass="option" onchange="setField(this.value)"/></td>
		</tr>
		<tr>
			<td colspan="2">
				<div id="game"></div>
...
$RCSfile: bo_dg_rep_sale_Menu.jsp,v $
