...
<div align="center">
	<h3>
		<u><s:text name="label.draw"/> <s:text name="PWT" /> <s:text name="Report"/> <s:property value="%{reportType}" />&nbsp;
...
<table width="100%" border="1" cellpadding="3" cellspacing="0"
	...
	<s:if
		...
		<tr align="center">
			...
			<th>
				<s:text name="Prize"/> <s:text name="label.amount"/>
			</th>
			<th>
...
$RCSfile: bo_rep_drawPwtReport_GameWiseExpand.jsp,v $
$Revision: 1.1.2.10.6.3 $
</code>