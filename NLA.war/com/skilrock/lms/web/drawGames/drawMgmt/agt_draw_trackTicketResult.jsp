...
<%
					...
					<table width="100%" border="1" cellpadding="3" cellspacing="0"
						...
						%>
						<tr>
							<th align="center" nowrap="nowrap" colspan="8">This Ticket Has Been Blocked By Back Office For <% if("NA".equals(drawBean.getDrawname())){%>This Draw<%}else{ %><%=drawBean.getDrawname()%><%} %></th>	
						</tr>
						<% 
						}
						%>
...
$RCSfile: agt_draw_trackTicketResult.jsp,v $
$Revision: 1.1.2.5.4.2.2.2 $
</code>