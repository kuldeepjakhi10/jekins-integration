...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
		...
		<script>
			function getData() 
			{
				...
				var tblData = "<span><b>Report Name : </b></span>"+ reportTitle + "</br>";
				 tblData += "<span><b>Game Name : </b></span>"+document.getElementById("gameNo").options[document.getElementById("gameNo").selectedIndex].text+"</br>";
				 tblData += "<span><b>Start Date : </b></span>"+document.getElementById("dateOfDraw").value+"</br>";
				 tblData += "<span><b>Draw Name : </b></span>"+document.getElementById("drawName").value+"</br>";	
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					<s:text name="label.draw.wise.plr.intrst.analys" />
				</h3>


				<s:form name="searchgame"
					action="bo_rep_drawwise_combi_analysis_Search"
					onsubmit=" return validateFormEntriesNumberBetAmount()">
					...
					<table border="0" cellpadding="2" cellspacing="0" width="400"
									...
									<tr>
										<td>
											...
											<input type="button"
												...
												onclick="displayCalendar(document.getElementById('dateOfDraw'),'yyyy-mm-dd', this, '<%=dateOfDraw%>', '<s:property value="%{depDate}"/>', '')" />
										</td>
									</tr>
								</table>
							</td>
							...
							<td colspan="2">
								<div id="drawNameDiv" style="display: none;">
									...
									<s:select name="drawName" theme="simple" id="drawName"
										...
										cssClass="option" onchange="_id.i('down','');" required="true" />
								</div>
							</td>
						</tr>
						...
						<tr>
							<td colspan="2">
								<div id="drawDateTime" style="display: none;">
									<s:text name="label.draw.time" />
									<s:select name="drawTime" theme="simple" id="drawTime"
										headerKey="-1" headerValue="%{getText('label.please.select')}" list="{}"
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_rep_drawwise_combi_analysis_Menu.jsp,v $ $Revision:
	1.1.2.1 $
</code>