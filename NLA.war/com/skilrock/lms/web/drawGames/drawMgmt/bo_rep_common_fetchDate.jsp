...
<s:set name="stDate" id="stDate" value="#session.presentDate" />
	<tr>
		<td>
    		...
    		<input  type="text" name="fromDate" id="start_date" value="<s:property value="%{stDate}"/>" readonly size="12">
	...
	<tr>
		<td>
    		...
    		<input  type="text" name="toDate" id="end_date" value="<s:property value="%{stDate}"/>" readonly size="12">
...
$RCSfile: bo_rep_common_fetchDate.jsp,v $
$Revision: 1.2.8.2 $
</code>