		...
		<div id="wrap">
			<div id="top_form">
				<s:if test="%{#session.plrPwtAppDetMap.isAnonymous}">
					<h3>
						<s:text name="label.pls.pay"/> <s:property value="#application.CURRENCY_SYMBOL" /> 
						<b><s:property
				...
				<s:else>
					<h3>
						...
						<s:text name="label.has.reg.for"/> <s:text name="Direct_Player"/> <s:text name="PWT"/> <s:text name="label.process"/>.
										...
										<param name="data" value="108172000002746000" />
											<div style="font-size:12px; height:300px; line-height:center;">
												<table>
													...
													<s:text name="msg.no.java.rt.found"/>!!<br/>
										        	<a style="color:red" href="<%=request.getContextPath()%>/com/skilrock/lms/web/drawGames/common/jre-1_5_0_12-windows-i586-p.exe"><s:text name="msg.click.to.install"/></a>
										        	</td>
										        	</tr>
									        	</table>
									        </div>
...
$RCSfile: bo_draw_pwt_dirPlr_RegisSuccess.jsp,v $
$Revision: 1.1.2.2.4.2.2.11.10.2 $
</code>