	var i18nOb = top.frames[0].i18Obj;
		...
		function verifyNSave(){
			...
			if(tktNo=="" && virnCode==""){
			  _id.i("gName_e", i18nOb.prop('error.tickt.no.or.virin.no.empty'), "e");
				isValid = false;
				return false;		
			}
		...
		parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/pwtMgmt/backOffice/js/ticketBookTrackar.js,v $'] = '$Id: ticketBookTrackar.js,v 1.1.8.1.8.1.2.1 2014/12/10 10:37:39 yogesh Exp $';