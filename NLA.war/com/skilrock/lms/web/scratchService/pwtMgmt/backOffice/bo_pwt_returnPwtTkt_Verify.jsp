...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
  ...
  <div id="top_form">
   <h3>Change <s:text name="PWT"/> Ticket Status @ BO</h3>
		<s:form action="bo_pwt_returnPwtTkt_Save.action">
...
<s:else>			
			...
			<table border="1" width="75%" cellpadding="2" cellspacing="0">
			<tr>
			  <td><s:a theme="simple" href="bo_pwt_returnPwtTkt_Menu.action">Change Status For Another PWT</s:a></td>
			</tr>
...
$RCSfile: bo_pwt_returnPwtTkt_Verify.jsp,v $
$Revision: 1.1.8.3 $
</code>