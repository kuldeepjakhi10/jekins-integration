...
<body>
       ...
       <table border="1" cellpadding="4" cellspacing="0" width="100%" align="center" bordercolor="#cccccc">
	    ...
	    <s:iterator value="%{pwtReqDetailsList}">
	       <tr>
	          <td><a href="#"  onclick="showdetails('<s:property value="%{request_id}"/>','<s:property value="%{req_status}"/>','<s:property value="%{partyName}"/>','<s:property value="%{pwt_amt}"/>','<s:property value="%{requestedByOrgName}"/>','<s:property value="%{task_id}"/>','<s:property value="%{requested_by_org_id}"/>','<s:property value="%{ticket_nbr}"/>','<s:property value="%{virn_nbr}"/>','<s:property value="%{game_id}"/>','<s:property value="%{game_nbr}"/>','<s:property value="%{requester_type}"/>')"><s:property value="%{request_id}"/></a></td>
