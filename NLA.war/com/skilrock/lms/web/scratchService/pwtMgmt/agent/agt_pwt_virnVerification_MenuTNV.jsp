...
<title><%=application.getAttribute("JSP_PAGE_TITLE")%></title>
	...
	<script  src="<%=request.getContextPath() %>/com/skilrock/lms/web/scratchService/pwtMgmt/agent/js/agt_pwtMgmt_pwtCommonFnAgtTNV.js"></script>
...
function validateData(){
      // alert('inside validate data');
		var isInValid = false;
			
		if(checkTktVirnBinding())
		{
		  return false;		  
		}		
		var checkDup = checkDuplicateNew('Virn');
		//alert('on jsp dup is ' + checkDup.dup);			
...
<div id="wrap">
<div id="top_form">
	<h3>VIRN Validation for Winning Receipt TNV</h3>
	
		<s:form name="pwtAgent" action="agt_pwt_virnVerification_Save_TNV" onsubmit="return _subTrans()">
		<s:hidden name="retUserId"  id="retUserId"></s:hidden>
...
$RCSfile: agt_pwt_virnVerification_MenuTNV.jsp,v $
$Revision: 1.1.2.6 $
</code>