...
function isNumericForGameNumber(elem, helperMsg){
	...
	{
	  var elem1=elem.name+"1";
	  document.getElementById(elem1).innerHTML = "<font color = 'red'>"+i18nOb.prop('error.game.no.cant.zero')+"</font>";
	  return false;
	}
	if(elem.value.match(numericExpression)){
	doReset(elem);
...
function isValidateDate(){
  ...
  { //alert("second");
  //alert(flag1);
  document.getElementById('startDate1').innerHTML = "<font color = 'red'>"+i18nOb.prop('error.pls.entr.start.date')+"</font>";
   }
  else{
...
var pwtendDate = dojo.widget.byId("pwtendDate");
 ...
 // alert(pwtDate);
  ...
  { //alert("third");
   //alert(flag1);
  document.getElementById('saleendDate1').innerHTML = "<font color = 'red'>"+i18nOb.prop('error.pls.sale.end.date')+"</font>";
  ...
  {//alert("four");
   //alert(flag1);
  document.getElementById('pwtendDate1').innerHTML = "<font color = 'red'>"+i18nOb.prop('error.pls.pwt.end.date')+"</font>";
...
//alert("five");
 ...
 //alert("six");
  document.getElementById('saleendDate1').innerHTML = "<font color = 'red'>"+i18nOb.prop('error.pls.slct.sale.end.date.grtr.then.stard.date')+"</font>";
// alert("Please Select to sale date Greater than start Date");
 ...
 //  alert(flag1);
  if(saleDate=="" || pwtDate=="" || saleDate>pwtDate){
   //alert("seven1");
  document.getElementById('pwtendDate1').innerHTML = "<font color = 'red'>"+i18.prop('error.pls.slct.sale.end.date.grtr.then.stard.date')+"</font>";
...
if ( document.uploadForm.supplierName.value == "-1" )
    {
       // alert ( "Please select Printer." );
		document.getElementById('selectSupp').innerHTML = "<font color = 'red'>"+i18nOb.prop('error.pls.slct.printer')+" </font>";
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/gameMgmt/backOffice/js/ADM_ST5_Validation.js,v $'] = '$Id: ADM_ST5_Validation.js,v 1.1.20.1 2014/12/10 10:37:01 yogesh Exp $';