...
<body>
  ...
  <s:form name="searchgame" action="agt_rep_sale_Search" onsubmit="return validateDates()"> 		
	 <table  border="0" cellpadding="2" cellspacing="0" width="400px">
		...
		<tr>
			<td><s:select name="groupBy" label="Order By " list="#{'Retailer Wise':#application.TIER_MAP.RETAILER + ' Wise','Game Wise':'Game Wise'}" cssClass="option"/></td>
		</tr>
		<tr>
...
$RCSfile: agt_rep_sale_Menu.jsp,v $
$Revision: 1.1.8.4 $
</code>