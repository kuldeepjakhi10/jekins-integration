	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				...
				<s:form action="bo_rep_scratchSaleReport_Search">
						...
						<tr>
							<td align="center" colspan="2">
								<s:select name="reportType" label="%{getText('Report')} Type "
									list="#{'Game Wise':getText('label.gamewise'),'Agent Wise':getText('label.agentwise')}"
									cssClass="option"
									onchange="clearDiv()" />
							</td>
						</tr>
...
$RCSfile: bo_rep_scratchSaleReport_Menu.jsp,v $
