...
<div align="center"><h3><u>Purchase <s:text name="Report"/> &nbsp;
	...
	<%} else {out.println("Of : "+((DateBeans)session.getAttribute("datebean") ).getReportType());}%>
	 ...
	 <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#CCCCCC" align="center">
		<tr>
			...
			<th width="6%"  nowrap="nowrap">Cost/Ticket</th>
			<th width="8%" >Tickets/Book</th> 
			<!--  <th width="8%" >Existing Books </th>-->			
			<th width="10%">Books Purchased</th>			
			<th width="10%">Books Returned</th>
			<th width="10%" >Books Remaining</th>	
		</tr>		
