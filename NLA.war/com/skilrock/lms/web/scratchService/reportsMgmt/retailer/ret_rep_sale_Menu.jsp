...
<body>
	...
	<div id="wrap">
     <div id="top_form">
  <h3>Purchase <s:text name="Report"/></h3>
	
	
  <s:form name="searchgame" action="ret_rep_sale_Search" onsubmit="return validateDates()"> 		
	 <table  border="0" cellpadding="2" cellspacing="0" width="400px">
		<tr>
			<td colspan="2"><s:select name="totaltime" label="Get Purchase %{getText('Report')} " list="{'Current Day','Current Week','Current Month','Date Wise'}" cssClass="option" onchange="setInputField(this.value)" /></td>
		</tr>
...
$RCSfile: ret_rep_sale_Menu.jsp,v $
$Revision: 1.1.8.3 $
</code>