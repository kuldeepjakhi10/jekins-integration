...
<head>
	...
	<script type="text/javascript" src="<%=request.getContextPath() %>/com/skilrock/lms/web/scratchService/orderMgmt/retailer/js/ret_orderMgmt_quickOrderReq.js"/>
...
<div id="wrap">
<div id="top_form">
	<h3>Quick Order Request To <s:property value="#application.TIER_MAP.AGENT" /></h3>
	
		<s:form name="pwtAgent" action="ret_om_quickOrder_Save"  onsubmit="return validate()">
...
$RCSfile: ret_om_quickOrder_Menu.jsp,v $
$Revision: 1.1.8.3 $
</code>