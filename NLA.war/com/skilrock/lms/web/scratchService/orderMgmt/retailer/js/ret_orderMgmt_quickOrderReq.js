		...
		function fetchDet(){
			...
			var _resp  = _ajaxCall("getGameNameListForRet.action?gameStatus=OPEN");
			if(_resp.result){
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/orderMgmt/retailer/js/ret_orderMgmt_quickOrderReq.js,v $'] = '$Id: ret_orderMgmt_quickOrderReq.js,v 1.1 2010/04/02 12:12:11 gaurav Exp $';
