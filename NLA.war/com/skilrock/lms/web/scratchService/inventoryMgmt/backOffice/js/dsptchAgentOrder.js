...
function verifyAgentPack(packNbr,div) {
  ...
  url = "verifyAgentPack.action?gameNbr="+gameNumber+" & gameId="+gameId+"&packNbrToVerify="+ packNbr+ "&packNbr =" + agtPacks +"& packCountId = " + div ;
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/scratchService/inventoryMgmt/backOffice/js/dsptchAgentOrder.js,v $'] = '$Id: dsptchAgentOrder.js,v 1.1.2.1 2010/09/14 03:42:38 gaurav Exp $';
