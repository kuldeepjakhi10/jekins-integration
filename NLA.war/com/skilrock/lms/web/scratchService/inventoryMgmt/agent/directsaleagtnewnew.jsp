...
<div id="top_form">
	<h3>Direct Sale Process</h3>
		...
		<s:form name="directSale" action="directDispatchBooks" onsubmit="return onSub()">
		<table border="0" cellpadding="3" cellspacing="0" width="100%">
			<tr>
				<td width="70%">
					<div id="retOrgDiv" style="text-align: left;"></div>
							<table><tr><td align="right"><i><s:property value="#application.TIER_MAP.RETAILER" /> Name : </i></td><td><select class="option"  name="retOrgName" id="retOrgName" onchange="return verifyRetailer(this.value);">
...
$RCSfile: directsaleagtnewnew.jsp,v $
