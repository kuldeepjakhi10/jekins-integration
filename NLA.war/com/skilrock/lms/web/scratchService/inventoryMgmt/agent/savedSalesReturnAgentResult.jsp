		...
		<table width="75%">
			<tr>
				...
				<td width="30%" align="left">
					<a href="<%=request.getContextPath() %>/com/skilrock/lms/inventory/displaySalesReturnEntryPageAgent.action">More Sale Return</a>
				</td>
					  ...
					  <td align="right"><a  href="<%=request.getContextPath() %>/com/skilrock/lms/account/deliveryChallenAgt.action?id=<%=session.getAttribute("DEL_CHALLAN_ID") %>&type=DSRCHALLAN" target="_blank">Show Sale Return Note</a></td>
			</tr>
		</table>
</div></div>
...
$RCSfile: savedSalesReturnAgentResult.jsp,v $
$Revision: 1.1.8.3 $
</code>