...
<h3>Your order has been successfully dispatched</h3>
		...
		<s:form>
			...
			<table>
			<tr>
			  <td><s:a theme="simple" href="agt_im_dispatchOrder_Menu.action">Dispatch Another Order</s:a></td>
			</tr>  
			<!--  
			<tr>  
			  <td>
			...
			<tr>
			   <td>
			      <a  href="<%=request.getContextPath() %>/com/skilrock/lms/web/reportsMgmt/agt_rep_showDeliveryChallen.action?id=<%=session.getAttribute("DEL_CHALLAN_ID") %>&type=DLCHALLAN" target="_blank">Show Delivery Challan</a>
			  </td>
			</tr>
...
$RCSfile: agt_im_dispatchOrder_Success.jsp,v $
$Revision: 1.1.8.2 $
</code>