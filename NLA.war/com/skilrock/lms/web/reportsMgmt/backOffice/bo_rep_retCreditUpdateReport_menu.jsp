...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=request.getContextPath() %>/com/skilrock/lms/web/reportsMgmt/backOffice/js/creditLimitHistoryRep.js"></script>
	...
	<body onload="getAgentList()">
		...
		<div id="wrap">
			<div id="top_form">
				...
				<s:form action="bo_retCreditUpdateReport_Search" onsubmit="return validateData(),validateDates()">
					<table width="450" border="0" cellpadding="2" cellspacing="0">
								...
								<div id="agtDiv">
									<table>
										<s:select cssClass="option" name="agtOrgId"
											...
											headerValue="--Please Select--" headerKey="-1" required="true" onchange="return setAgtName(this.value)"></s:select>
									</table>
								</div>
							</td>
						</tr>
						...
						<tr>
							<td align="center" colspan="2">
								...
								<div id="date" text-align: left; width: 60%">
						...
						<tr>
							<td>
								<s:hidden name="agtName" id="agtnameid" value=""></s:hidden>
							</td>
						</tr>
						<tr>
							<td>
...
$RCSfile: bo_rep_retCreditUpdateReport_menu.jsp,v $
