...
<div id="reportData">
	<table width="100%" border="1" cellpadding="3" cellspacing="0"
		...
		<tr>
			...
			<th width="10%" align="center">
				<s:text name="label.total.tkt.count" />
			</th>
			<th align="center">
				<s:text name="label.total.pwt.count" />
			</th>
			<th align="center">
				<s:text name="label.avg.sale.per.ret" />
			</th>
		</tr>
		<s:if test="#session.retActHistMapForSL.size>0">
			<s:iterator value="#session.retActHistMapForSL">
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_slrep_retActivity_History.jsp,v $ $Revision: 1.1.2.1 $
</code>