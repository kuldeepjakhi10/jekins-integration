		...
		<s:iterator id="result" value="#session.result">
			...
			<tr class="startSortable">
				...
				<th align="right" noWrap="nowrap">
					<s:set name="total"
						value="#drawCash+#scratchCash-#agtNetPayment+#csSaleAmt-#csCancelAmt+#olaDepoAmt-#olaWdAmt-#netGamingComm2+#sleCash"></s:set>
					<%=FormatNumber.formatNumberForJSP(pageContext
							.getAttribute("total"))%>
				</th>
				<th align="right" noWrap="nowrap">
				...
				<s:set name="totTotal"
					value="%{#totTotal+#drawCash+#scratchCash-#agtNetPayment+#csSaleAmt-#csCancelAmt+#olaDepoAmt-#olaWdAmt-#netGamingComm2+#sleCash}" />
