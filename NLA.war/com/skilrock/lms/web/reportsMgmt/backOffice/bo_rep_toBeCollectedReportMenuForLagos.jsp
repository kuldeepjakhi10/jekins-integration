		...
		<div id="wrap">
			<div id="top_form">
				...
				<s:form name="searchgame"
					action="bo_rep_toBeCollectedReportSearchForLagos">
									...
									<tr>
										<td>
											...
											<input type="button"
												...
												onclick="displayCalendar(document.getElementById('startDate'),'yyyy-mm-dd', this, '<%=startDate%>', false, '')" />
										</td>
									</tr>
								</table>
							</td>
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_rep_toBeCollectedReportMenuForLagos.jsp,v $ $Revision:
	1.1.2.4 $
</code>