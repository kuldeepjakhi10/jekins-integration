...
<div id="wrap" style="text-align: center">
	 ...
	 <table width="100%" border="1" cellspacing="0" cellpadding="4" align="left" bordercolor="#f8f8f8"><tr><td>
       ...
       <td align="center" colspan="7" bgcolor="#FFF0E1"><b>Reconciliation Details</b></td></tr>
        ...
        boolean empty=true;
			 ...
			 %>
		<tr><td class="label">
				<a dojoType="struts:Bind" onclick="document.getElementById('printBtn').style.display='none'" targets="detailrep" title="Click for Detailed View" href="bo_rep_reconciliation_Detail.action?agentName=<%=consolidatedBean.getUserName()%> & fromDate=<%=reconcilationList.get(reconcilationList.size()-2)%> & toDate=<%=reconcilationList.get(reconcilationList.size()-1)%>"><%=consolidatedBean.getUserName()%></a></td>
	...
	<br />
	<input type="button"  id="printBtn" class="button" value="Print Consolidated" onclick="printTable('backOffice/bo_rep_recon_consolidated_print.jsp') " />
	<br />
	<div id="detailrep"></div>
</body>
</html>
<code id="headId" style="visibility: hidden">
$RCSfile: bo_rep_reconciliation_Consolidated.jsp,v $
$Revision: 1.3.8.4 $
</code>