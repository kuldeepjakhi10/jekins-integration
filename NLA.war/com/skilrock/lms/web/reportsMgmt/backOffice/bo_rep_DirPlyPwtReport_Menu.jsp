...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					<s:text name="Direct_Player"/> <s:text name="PWT"/> <s:text name="Report"/>
				</h3>
				<s:form action="bo_rep_DirPlyPwtReport_Search">
					<table width="450" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td align="center" colspan="2">
								<s:radio name="reportType" label="%{getText('Report')} %{getText('label.type')}"
									value="'Agent Wise'"
...
$RCSfile: bo_rep_DirPlyPwtReport_Menu.jsp,v $
$Revision: 1.1.2.5.10.2 $
</code>