...
(function($) {
    ...
    function buildFixedTable(src, section, target) {
        if ($(section, src).length) {
            var th = $("<table id='subTab'></table>").appendTo(target);
            var tr = null;
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/reportsMgmt/backOffice/js/Attic/jquery.fixedtable.js,v $'] = '$Id: jquery.fixedtable.js,v 1.1.2.1 2012/12/29 07:27:05 yogesh Exp $';