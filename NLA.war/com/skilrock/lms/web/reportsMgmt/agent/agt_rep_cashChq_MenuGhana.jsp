...
<body>
	...
	<div id="wrap">
     <div id="top_form">
  <h3>Cash Cheque <s:text name="Report"/></h3>
	
	
  <s:form name="searchgame" action="agt_rep_cashChq_Search_Ghana" onsubmit="return validateDates()"> 		
	 <table  border="0" cellpadding="2" cellspacing="0" width="400px">
		<tr>
			<td><s:select name="totaltime" label="Get Cash & Cheque %{getText('Report')} " list="{'Current Day','Current Week','Current Month','Date Wise'}" cssClass="option" onchange="setInputField(this.value)" /></td>
		</tr>		
		<tr> 			
...
$RCSfile: agt_rep_cashChq_MenuGhana.jsp,v $
$Revision: 1.1.2.1 $
</code>