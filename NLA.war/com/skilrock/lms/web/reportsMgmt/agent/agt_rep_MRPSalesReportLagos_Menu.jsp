...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					MRP SALE <s:text name="Report"/> <s:text name="Retailer"/> Wise 
				</h3>
				<s:form action="agt_rep_MRPSalesReportLagos_Search" onsubmit="return validateDates()">
...
$RCSfile: agt_rep_MRPSalesReportLagos_Menu.jsp,v $
$Revision: 1.1.4.2 $
</code>