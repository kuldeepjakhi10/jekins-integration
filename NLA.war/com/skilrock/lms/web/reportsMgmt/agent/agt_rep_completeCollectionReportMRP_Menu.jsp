...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Sale <s:text name="PWT"/> <s:text name="Collection" /> <s:text name="Report"/> MRP WISE
				</h3>
				<s:form action="agt_rep_completeCollectionReportMRP_RetalerWise" onsubmit="return validateDates()">
					<table width="450" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td align="center" colspan="2">
								<s:radio name="reportType" label="%{getText('Report')} Type"
									value="'Retailer Wise'"
									list="#{'Retailer Wise':#application.TIER_MAP.RETAILER + ' Wise','Day Wise':'Day Wise'}"
									onclick="clearDiv()" />
							</td>
						</tr>
						<tr>
							<td align="center" colspan="2">
							<s:hidden name="agtOrgName" value="%{#session.USER_INFO.orgName}"></s:hidden>
...
$RCSfile: agt_rep_completeCollectionReportMRP_Menu.jsp,v $
$Revision: 1.1.4.2 $
</code>