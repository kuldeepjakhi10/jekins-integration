...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Transaction <s:text name="Report"/>
				</h3>
				<s:form action="agt_rep_TransactionReport_Search">
					<table width="450" border="0" cellpadding="2" cellspacing="0">
						...
						<tr>
							<td align="center" colspan="2">
							<s:hidden name="reportType" value="Retailer Wise Expand"></s:hidden>
							<!-- 	<s:radio name="reportType" label="Reports Type"
									value="'Retailer Wise Expand'"
									list="#{'Retailer Wise Expand':#application.TIER_MAP.RETAILER + ' Wise','Day Wise Expand':'Day Wise'}"
									onclick="clearDiv()" /> -->
							</td>
						</tr>
						<tr>
...
$RCSfile: agt_rep_TransactionReport_Menu.jsp,v $
$Revision: 1.1.2.4 $
</code>