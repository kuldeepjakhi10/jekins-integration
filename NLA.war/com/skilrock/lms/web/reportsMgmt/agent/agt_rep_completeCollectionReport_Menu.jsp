...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Sale <s:text name="PWT"/> <s:text name="Collection" /> <s:text name="Report"/>
				</h3>
				<s:form action="agt_rep_completeCollectionReport_RetalerWise" onsubmit="return validateDates()">
...
$RCSfile: agt_rep_completeCollectionReport_Menu.jsp,v $
$Revision: 1.1.2.10.8.1 $
</code>