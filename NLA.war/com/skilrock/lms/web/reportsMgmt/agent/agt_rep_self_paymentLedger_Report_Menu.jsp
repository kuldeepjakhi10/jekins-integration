...
function verifyAgent(){
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				<h3>
					Self Payment Ledger <s:text name="Report"/>
				</h3>
				<s:form action="agt_rep_self_payment_ledger_Search" onsubmit="return validateDates()">
...
$RCSfile: agt_rep_self_paymentLedger_Report_Menu.jsp,v $
