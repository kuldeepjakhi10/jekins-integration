...
<body>
	...
	<div id="wrap">
     <div id="top_form">
  <h3>Collection <s:text name="Report"/></h3>
	
	
  <s:form name="searchgame" action="agt_rep_collection_Search" onsubmit="return validateDates()"> 		
...
$RCSfile: agt_rep_collection_Menu.jsp,v $
