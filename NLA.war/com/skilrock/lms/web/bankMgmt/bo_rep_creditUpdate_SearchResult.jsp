...
<title><%=application.getAttribute("JSP_PAGE_TITLE")%></title>	
		...
		<body>
			...
			<table align="center">
			<tr>
			<td><h3><u> Bank Wise Credit Update   Report From Date: <s:property value="startDate"/> To Date: <s:property value="endDate"/></u></h3></td>
			</tr>
			</table>
				<table width="100%" border="1" cellpadding="3" cellspacing="0"
					...
					<s:iterator value="%{#dataBeanList}">
						...
						<s:property value="branchFullName" />&nbsp;	(<s:property value="branchName" />)
									...
									<td align="right">
									<s:set name="netMech"
										value="#netMech+totalMachines" />
									<s:property value="totalMachines" />
								</td>
								<td align="right">
						...
						<tr>
							...
							<td align="right"><s:property value="#netMech" /></td>
