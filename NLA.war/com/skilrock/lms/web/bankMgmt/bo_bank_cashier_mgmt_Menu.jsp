...
<head>
		...
		<script type="text/javascript"	src="<%=request.getContextPath()%>/com/skilrock/lms/web/bankMgmt/js/bank_cashier_mgmt.js"></script>
	<script>
	function getData() {
...
<%@include file="/com/skilrock/lms/web/loginMgmt/menu.jsp"%>
		<div id="wrap">
			...
			<s:form  action="bo_bank_cashier_mgmt_Search" id="searchForm" name="searchForm">
									...
									<tr>
											<td colspan="2" align="right">
													<s:submit name="search" id="search" value="Search" align="center"
																targets="down" theme="ajax" cssClass="button"  onclick="return validateDates()"/>
											</td>
								</tr>
...
<code id="headId" style="visibility: hidden">
	$RCSfile: bo_bank_cashier_mgmt_Menu.jsp,v $ $Revision:
	1.1.2.4 $
</code>