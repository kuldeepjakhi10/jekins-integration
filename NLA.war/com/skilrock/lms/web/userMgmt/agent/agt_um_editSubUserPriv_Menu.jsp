  ...
  function getUserPriveledges()
{
  ...
  var url='agt_um_editSubUserPriv_FetchPriv.action?userName='+userName;
    // alert("url is" +url);
...
for(var i=0;i<length;i++)
{
  ...
  <div id="top_form">
   <h3>Edit User Privileges</h3>
				...
				<s:form name="editUserPriv"	action="agt_um_editSubUserPriv_Save.action"	method="POST" onsubmit="return validate()">
		 ...
		 <tr><td>
	      <div id="userDiv"></div>
					<s:select label="User Name" id="userName" name="userName"
						...
						onchange="getUserPriveledges()" headerKey="-1" headerValue="-- Please Select --" required="true"></s:select>
	     </td></tr>
	     <tr>
...
$RCSfile: agt_um_editSubUserPriv_Menu.jsp,v $
$Revision: 1.3.8.3 $
</code>