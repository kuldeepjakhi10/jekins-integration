...
var _resp  = _ajaxCall("fetchRetailernGamenFmt.action");
	...
	for(i=0,l=retArr.length;i<l-1;i++) {
				var opt = new Option(retArr[i],retArr[i]);
...
parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/userMgmt/backOffice/js/pwtCommonFnAgt.js,v $'] = '$Id: pwtCommonFnAgt.js,v 1.1 2010/04/01 04:22:23 gaurav Exp $';