    ...
    */
    function AutoComplete_KeyDown(id)
    {
		...
		if ((keyCode >= 65 && keyCode < 91) || (keyCode >= 48 && keyCode < 58) || keyCode == 45 || keyCode == 27 ||keyCode == 13 ||keyCode == 40 || keyCode == 38 ||  (keyCode >= 96 && keyCode < 106 ||keyCode == 46 || keyCode == 8 || keyCode == 9 || keyCode == 189 ||keyCode == 109)) {
    ...
    */
    function AutoComplete_KeyUp(id)
    {
        ...
        var keyCode = event.keyCode;
       // alert(keyCode+"---**"+lenOfBookNum+"****"+id+"**"+document.getElementById(id).value);
        if(isEqualToLenOfBookNum(id)){
	        if(keyCode == 46 || keyCode == 8){}
	        else{
		        moveToNextElement(id);
    ...
    */
    ...
    totalElement = document.forms[0].elements.length
	   ...
	   parent.frames[0].Version['$Source: /rep/LMS_Mgmt/WebRoot/com/skilrock/lms/web/userMgmt/backOffice/js/Attic/AutoComplete.js,v $'] = '$Id: AutoComplete.js,v 1.1.2.2 2011/11/04 04:38:27 umesh Exp $';