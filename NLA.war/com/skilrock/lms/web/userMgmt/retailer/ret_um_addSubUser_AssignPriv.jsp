...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		...
		<div id="wrap">
			<div id="top_form">
				...
				<s:form action="ret_um_addSubUser_AssignPriv.action" method="POST"
	   ...
	   `<table width="300" cellpadding="2" cellspacing="0" border="0">
		...
		<table width="830px" cellpadding="2" cellspacing="0" border="0">
									<tr>
										<td>
											<%
	...
	colorcode = 2; %>
	<th height="25" class="color<%=colorcode %>" id="ser_col<%=i%>" onclick="showHideTab('inter_tbl<%=i%>')"
...
$RCSfile: ret_um_addSubUser_AssignPriv.jsp,v $
$Revision: 1.8.2.1.6.3 $
</code>