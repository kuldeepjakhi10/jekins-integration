...
return document.error_disp_handler.isValid;
	...
	<%@include
		...
		%>
				<s:form name="newsubuser" action="ret_um_addSubUser_Save" onsubmit="return isRetUserValidation()">
...
$RCSfile: ret_um_addSubUser_Menu.jsp,v $
$Revision: 1.3.8.3 $
</code>